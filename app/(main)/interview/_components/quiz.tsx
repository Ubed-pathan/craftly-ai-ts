...
import { generateQuiz, saveQuizResult, type QuizQuestion, type AssessmentResult } from "@/actions/interview";
...
export default function Quiz() {
  ...
  const startNewQuiz = () => {
    ...
    setShowExplanation(false);
    void generateQuizFn();
    setResultData(null as unknown as AssessmentResult | null);
  };
  ...
  if (!quizData) {
    return (
      <Card className="mx-2">
        ...
        <CardFooter>
          <Button onClick={() => void generateQuizFn()} className="w-full">Start Quiz</Button>
        </CardFooter>
      </Card>
    );
  }
  ...
  return (
    <Card className="mx-2">
      ...
      <CardContent className="space-y-4">
        ...
        <RadioGroup onValueChange={handleAnswer} value={answers[currentQuestion] ?? undefined} className="space-y-2">
