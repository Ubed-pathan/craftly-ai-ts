...
type SalaryRange = { role: string; min: number; max: number; median: number };
type Insights = {
...
const DashboardView = ({ insights }: { insights: Insights }) => {
  ...
  const OutlookIcon = getMarketOutlookInfo(insights.marketOutlook).icon as any;
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Last updated {nextUpdateDistance}</p>
          </CardContent>
        </Card>
